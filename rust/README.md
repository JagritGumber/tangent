...
- `MarketReadPlan` for composing market registry and mark-price read calls, plus fixed-order market metadata and order-constraint decoding before order construction.
